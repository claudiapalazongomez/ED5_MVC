...
public class Vista
{
	...
	Checkbox chkCuatroPuertas = new Checkbox("4 puertas", false,
	grupoPuertas);
	Checkbox chkCincoPuertas = new Checkbox("5 puertas", false,
	grupoPuertas);
	...
	Checkbox chkPinturaNoMetalizada = new Checkbox("No", false,
	grupoPintura);
